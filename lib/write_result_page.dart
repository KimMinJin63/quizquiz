...
class WriteResultPage extends StatelessWidget {
  const WriteResultPage({super.key});
      ...
      body: SafeArea(
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            String? question = box.read('write_quiz_${quizs[index]['number']}');
            String? answer =
                box.read('write_quiz_answer_${quizs[index]['number']}');
            return Padding(
